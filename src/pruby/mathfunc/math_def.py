...
def interpolate(y,y1,y2,x1,x2):
    """
    Linear interpolation of data between two points.

    Input
    -----------------------------------------------------------------
    y: float
        y value to be interpolated
    y1,y2,x1,x2: float
        values of y and x next to the value that needs to be interpolated
